sap.ui.define(['sap/ui/core/UIComponent', 'sap/ui/model/json/JSONModel', 'dynamic/SimpleForm/js/Control'],
    function(UIComponent, JSONModel, SimpleForm) {
        "use strict";
        ...
        var Component = UIComponent.extend("dynamic.SimpleForm", {
            ...
            runSetup: function(sId, sMethod, sSubject, sClass) {
                ...
                this.resetDataModel();
                this.view.setModel(this._oDataModel, sMethod + sSubject + sClass);
