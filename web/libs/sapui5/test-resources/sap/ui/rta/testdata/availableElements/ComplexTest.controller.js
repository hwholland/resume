(function(){
	...
	sap.ui.controller("sap.ui.rta.test.ComplexTest", {
		...
		onInit : function () {
			...
			sURL = "/destinations/E91/sap/opu/odata/SAP/AvailableElementsTest/?sap-documentation=all";
			...
			this.getView().byId("GroupEntityType02").bindElement("/EntityTypes2(EntityType02_Property01='EntityType02Property01Value')");
		},
