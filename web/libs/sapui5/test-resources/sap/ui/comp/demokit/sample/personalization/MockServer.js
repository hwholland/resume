jQuery.sap.declare("sap.ui.comp.sample.personalization.MockServer");
...
sap.ui.comp.sample.personalization.MockServer = {

	server : null,

	rootUri : "/mockserver/",

	dataPath : "test-resources/sap/ui/comp/demokit/sample/personalization/mockserver/",
