sap.ui.controller("sap.ui.comp.sample.personalization.example8.Example", {
	...
	onInit: function() {
		...
		this.oMockServer = new sap.ui.core.util.MockServer({
			rootUri: "demokit.personalization.example8/"
		});
		...
		this.oModel = new sap.ui.model.odata.ODataModel("demokit.personalization.example8", true);
