sap.ui.controller("sap.ui.vbm.sample.GeoMapGeoCircles.C", {
	
	onInit : function () 
	{
	    var oModel = new sap.ui.model.json.JSONModel("test-resources/sap/ui/vbm/demokit/sample/GeoMapGeoCircles/Data.json");
...
//		alert("GeoCircle onContextMenu");
   ...
   onOpenDetail: function (evt) 
   {
      ...
      cont.innerHTML = "Content for Geocircles";
