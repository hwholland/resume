...
jQuery.sap.declare("messages.enabled.Component");

// new Component
sap.ui.core.UIComponent.extend("messages.enabled.Component", {
...
messages.enabled.Component.prototype.createContent = function(){
	...
	var oForm = new sap.ui.layout.form.Form({
		...
		formContainers: [
			new sap.ui.layout.form.FormContainer({
				title: "Component: Contact Data - validation enabled",
				formElements: [
