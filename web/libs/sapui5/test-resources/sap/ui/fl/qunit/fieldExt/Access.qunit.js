...
(function(Access) {
	...
	var oHttpErrorResponseWithT100Message = {
		"error": {
			"code": "CFD_GW_UI/007",
			"message": {
				"lang": "en",
				"value": "Action GetBusinessContextsByEntityType (Retrieval of Business Contexts by service Entity) failed."
			},
			"innererror": {
				"transactionid": "54E429A74593458DE10000000A420908",
				"timestamp": "20150219083115.1232240",
				"Error_Resolution": {
					"SAP_Transaction": "Run transaction /IWFND/ERROR_LOG on SAP NW Gateway hub system and search for entries with the timestamp above for more details",
					"SAP_Note": "See SAP Note 1797736 for error analysis (https://service.sap.com/sap/support/notes/1797736)"
				},
				"errordetails": [
					{
						"code": "CX_CFD_UI_FACADE",
						"message": "Parameters Inconsistent: entity type name , entity set name",
						"propertyref": "",
						"severity": "error",
						"target": ""
					}, {
						"code": "CX_APS_CUSTOM_FIELD_TECH",
						"message": "Action GetBusinessContextsByEntityType (Retrieval of Business Contexts by service Entity) failed",
						"propertyref": "",
						"severity": "error",
						"target": ""
					}
	...
	var oServiceUri = {
		...
		sPrefix: "/uilib-sample/proxy/https/ldai3e91:44300",
	...
	QUnit.test('getBusinessContextsByEntityType', function(assert) {
		var sServiceUrl = "/uilib-sample/proxy/https/ldai3e91:44300/sap/opu/odata/SAP/CFD_TSM_BUPA_MAINT_SRV";
		...
		//			                                    				}, '{ "results":[{"BusinessContext":"CFD_TSM_BUPA_ADR"},{"BusinessContext":"CFD_TSM_BUPA"}] }'
		//			                                    			]);
	...
	QUnit.test("Test logon system not available", function( assert ) {
		var logonSystem = null;
	
		// Remove getLogonSystem
		if (sap && sap.ushell && sap.ushell.Container && sap.ushell.Container.getLogonSystem) {
			logonSystem = sap.ushell.Container.getLogonSystem;
			delete sap.ushell.Container.getLogonSystem;
		}
		...
		// Unmock 
		if (logonSystem) {
			sap.ushell.Container.getLogonSystem = logonSystem;
		}
	});
	...
	QUnit.test("Test set service invalid with relative uri", function( assert ) {
		var oUnchangedAccess = mockAccessJs();
		var service = "/sap/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV";
		var serviceAsObject = {
			"serviceName": "CFD_TSM_SALES_ORDER_MAINT_SRV",
			"serviceVersion": "0001"
		};
	...
	QUnit.test("Test set service invalid with relative and version uri", function( assert ) {
		var oUnchangedAccess = mockAccessJs();
		var service = "/sap/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002";
		var serviceAsObject = {
			"serviceName": "CFD_TSM_SALES_ORDER_MAINT_SRV",
			"serviceVersion": "0002"
		};
	...
	QUnit.test("Parse service version of relative uri", function( assert ) {
		checkServiceVersion("sap/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002", 		 "0002");
		checkServiceVersion("/sap/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002/", 	 "0002");
		checkServiceVersion("sap/opu/odata/ns/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002", 		 "0002");
		checkServiceVersion("/sap/opu/odata/ns/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002/", 		 "0002");
		checkServiceVersion("/foo/opu/odata/ns/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002/", 	 	 "0002");
		checkServiceVersion("/foo/opu/odata/ns/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002", 		 "0002");
		checkServiceVersion("foo/opu/odata/ns/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002/", 		 "0002");
		checkServiceVersion("foo/opu/odata/ns/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002", 		 "0002");
		checkServiceVersion("foo/opu/odata/ns/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002;w=foo", 	 "0002");
		checkServiceVersion("sap/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV", 				 "0001");
		checkServiceVersion("sap/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002;v=0004", "0002");
		checkServiceVersion("foo/opu/odata/ns/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002;w=foo?$format=json", 	"0002");
		checkServiceVersion("sap/opu/odata/ns/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002;w=foo?$format=json", 	"0002");
	});
	
	QUnit.test("Parse service name", function( assert ) {
		// 1.) Case
		checkServiceName("/sap/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV" 		 , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/sap/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV/" 		 , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/sap/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002"   , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/sap/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002/"  , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		...
		checkServiceName("sap/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002;w=foo?$format=xml"  , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		
		// 2.) Case
		checkServiceName("/sap/opu/odata/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV" 		 , "/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/sap/opu/odata/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV/" 		 , "/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/sap/opu/odata/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002"   , "/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/sap/opu/odata/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002/"  , "/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("sap/opu/odata/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV" 		     , "/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("sap/opu/odata/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV/" 		 , "/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("sap/opu/odata/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002"    , "/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV");
		...
		// 3.) Case
		checkServiceName("/foo/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV" 		 , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/foo/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV/" 		 , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/foo/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002"   , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/foo/opu/odata/SAP/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002/"  , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		...
		checkServiceName("/foo/opu/odata/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV" 		 , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/foo/opu/odata/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV/" 		 , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/foo/opu/odata/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002"   , "CFD_TSM_SALES_ORDER_MAINT_SRV");
		checkServiceName("/foo/opu/odata/PAS/CFD_TSM_SALES_ORDER_MAINT_SRV;v=0002/"  , "CFD_TSM_SALES_ORDER_MAINT_SRV");
