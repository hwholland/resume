...
(function (window) {
	...
	TOLDataMaker.prototype = new sap.gantt.DataMaker();
	...
	TOLDataMaker.prototype.makeData = function () {
		...
		this.addRow("root", "order_0", {"uuid": "01_0",
				"status": 2,
				"start_loc_id": "WDF",
				"end_loc_id": "BERLIN",
				"id": "0000",
		...
		this.addRow("root", "order_01", {"uuid": "01_1",
				"status": 2,
				"start_loc_id": "PARIS",
				"end_loc_id": "LISBON",
				"id": "0001",
		...
		this.addRow("root", "order_02", {"uuid": "01_2",
				"status": 1,
				"start_loc_id": "WDF",
				"end_loc_id": "BERLIN",
				"id": "0002",
		...
		this.addRow("root", "order_03", {"uuid": "01_3",
				"status": 2,
				"start_loc_id": "MOSCOW",
				"end_loc_id": "PARIS",
				"id": "0003",
		...
		this.addRow("root", "order_04", {"uuid": "01_4",
				"status": 2,
				"start_loc_id": "BERLIN",
				"end_loc_id": "WDF",
				"id": "0004",
		...
		this.addRow("root", "order_05", {"uuid": "01_5",
				"status": 1,
				"start_loc_id": "WDF",
				"end_loc_id": "LISBON",
				"id": "0005",
		...
		this.addRow("root", "order_06", {"uuid": "01_6",
				"status": 2,
				"start_loc_id": "BERLIN",
				"end_loc_id": "WDF",
				"id": "0006",
		...
		this.addRow("root", "order_07", {"uuid": "01_7",
				"status": 0,
				"start_loc_id": "PARIS",
		...
		this.addRow("root", "order_08", {"uuid": "01_8",
				"status": 2,
				"start_loc_id": "BERLIN",
				"end_loc_id": "WDF",
				"id": "0008",
		...
		this.addRow("root", "order_09", {"uuid": "01_9",
				"status": 2,
				"start_loc_id": "BERLIN",
				"end_loc_id": "WDF",
				"id": "0009",
		...
		this.addRow("root", "order_10", {"uuid": "01_10",
				"status": 2,
				"start_loc_id": "BERLIN",
				"end_loc_id": "WDF",
				"id": "00010",
		...
		this.addRow("root", "order_11", {"uuid": "01_11",
				"status": 2,
				"start_loc_id": "BERLIN",
				"end_loc_id": "WDF",
				"id": "00011",
	...
	window.sap.gantt.TOLDataMaker = window.sap.gantt.TOLDataMaker || TOLDataMaker;
})(window);
