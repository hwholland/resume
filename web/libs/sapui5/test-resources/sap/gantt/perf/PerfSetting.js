	...
	var PerfSetting = ManagedObject.extend("sap.gantt.perf.PerfSetting", {
		...
		metadata: {
			...
			properties: {
				 ...
				 * includeToolbar.
				 */
				includeToolbar: { type: 'bool', defaultValue: false },
				 ...
				 * Show Calendar.
				 */
				showCalendar: { type: 'bool', defaultValue: true },

				/**
				 * Relationship.
				 */
				showRelationship: { type: 'bool', defaultValue: false },

				/**
				 * Show warning.
				 */
				showWarning: { type: 'bool', defaultValue: false }
