...
(function () {
    "use strict";
    /*jslint nomen: true*/
    /*global deepEqual, module, ok, sap, test, strictEqual, jQuery, sinon, throws, URI */
    ...
    test("sap.ushell.User: changed property handling", function () {
        ...
        // Act
        oUser.setChangedProperties(aExpectedChangedProperties[0].name, aExpectedChangedProperties[0].oldValue,
