...
(function () {
    "use strict";
    /*global asyncTest, deepEqual, equal, jQuery, module, ok, sap, start, test, throws, sinon, strictEqual */
    ...
    asyncTest("isIntentSupported: success", function () {
        ...
        // code under test
        oAdapter.isIntentSupported(aIntents).fail(sap.ushell.test.onError)
    ...
    asyncTest("isIntentSupported: single intent", function () {
        ...
        // code under test
        oAdapter.isIntentSupported([sIntent]).fail(sap.ushell.test.onError)
            .done(function (mSupportedByIntent) {
                start();
                bResolved = true;
    ...
    asyncTest("isIntentSupported: zero intents ([])", function () {
        ...
        sinon.stub(oAdapter, "resolveHashFragment", sap.ushell.test.onError);

        // code under test
        oAdapter.isIntentSupported([]).fail(sap.ushell.test.onError)
            .done(function (mSupportedByIntent) {
                start();
