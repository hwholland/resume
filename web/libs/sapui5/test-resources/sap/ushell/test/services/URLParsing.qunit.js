...
(function () {
    "use strict";
    /*global deepEqual, equal, jQuery, module, ok, sap, sinon, stop, strictEqual, test, throws, URI*/
    ...
    test("paramsToString Escaping", function () {
        var oRes = sap.ushell.Container.getService("URLParsing").paramsToString({ "/AB/C" : [ "3A" ], DEF: [ "4B" ], AAAA : ["2", "1"]});
    ...
    test("paramsToString Empty", function () {
        var oSrvc = sap.ushell.Container.getService("URLParsing");
        deepEqual(oSrvc.paramsToString({}), "");
        deepEqual(oSrvc.paramsToString(), "");
    });
