...
(function () {
    "use strict";
    /*global deepEqual, equal, module, ok, stop, test, jQuery, sap, sinon */
    /*jslint nomen: true*/
    ...
    test("smokeShortenExpand", function () {
        ...
        aLongUrl = "#SO-ABC~CONTXT?ABC=3&DEF=4&DEF=AAAAAAAAAAAAAABBBBBBBBBBBB&DEF=JJJJJJJJJJJJJJJJJJ&/detail/1?A=B";
        sHash = shortener.compactHash(aLongUrl, undefined ,{ getNextKey : function() {
            return "AGUID";
        }}).hash;
    ...
    test("expandNoStorage", function () {
        ...
        shortener.URL_LENGTH_LIMIT = 60;
        shortener.URL_PARAMS_LENGTH_LIMIT = 20;
        sHash = shortener.compactHash("#SO-ABC~CONTXT?ABC=3&DEF=4&DEF=AAAAAAAAAAAAAABBBBBBBBBBBB&DEF=JJJJJJJJJJJJJJJJJJ&/detail/1?A=B", undefined, { getNextKey : function() {
            return "AGUID";
        }}).hash;
    ...
    test("expandParamGivenRetrievalFunction key not present", function () {
        var shortener = sap.ushell.Container.getService("URLShortening"),
            sExpandedHash;
        sExpandedHash = shortener.expandParamGivenRetrievalFunction("#SO-Action?HIJ=5&ABC=3&DEF=4", "GIBTSNICHT", function (sKey) {
            return undefined;
        });
    ...
    test("expand With app state (special paramter retained)", function () {
        ...
        shortener.URL_LENGTH_LIMIT = 60;
        shortener.URL_PARAMS_LENGTH_LIMIT = 20;
        sHash = shortener.compactHash("#SO-ABC~CONTXT?ABC=3&DEF=4&DEF=AAAAAAAAAAAAAABBBBBBBBBBBB&DEF=JJJJJJJJJJJJJJJJJJ&sap-xapp-state=12A34&HIJ=1&/detail/1?A=B", ["HIJ"], { getNextKey : function() {
            return "AGUID";
        }}).hash;
        sHash = sHash.replace(/AGUID/, "BGUID");
    ...
    test("expand/compact With sap-system (special paramter retained)", function () {
        ...
        sHash = shortener.compactHash("#SO-ABC~CONTXT?ABC=3&DEF=4&DEF=AAAAAAAAAAAAAABBBBBBBBBBBB&sap-system=ABC&DEF=JJJJJJJJJJJJJJJJJJ&sap-xapp-state=12A34&HIJ=1&/detail/1?A=B", ["HIJ"], { getNextKey : function() {
            return "AGUID";
        }}).hash;
        sHash = sHash.replace(/AGUID/, "BGUID");
    ...
    test("expand With no app state (no special parameter)", function () {
        ...
        shortener.URL_LENGTH_LIMIT = 60;
        shortener.URL_PARAMS_LENGTH_LIMIT = 20;
        sHash = shortener.compactHash("#SO-ABC~CONTXT?ABC=3&DEF=4&DEF=AAAAAAAAAAAAAABBBBBBBBBBBB&DEF=JJJJJJJJJJJJJJJJJJ&sap-uapp-state=1234&HIJ=1&OPQ=4&OPQ=R&/detail/1?A=B", ["HIJ", "OPQ", "KLM"], { getNextKey : function() {
            return "AGUID";
        }}).hash;
        sHash = sHash.replace(/AGUID/, "BGUID");
    ...
    test("_cmpByList", function () {
        var shortener = sap.ushell.Container.getService("URLShortening");
        /* eslint-disable yoda */
        ok(0 > shortener._cmpByList(["D", "C"], "A", "B"), "compares 1");
        ok(0 < shortener._cmpByList(["D", "C"], "B", "A"), "compares 1");
        ok(0 === shortener._cmpByList(["D", "C"], "A", "A"), "compares 1");
        ok(0 === shortener._cmpByList(["D", "C"], "A", "A"), "compares 1");
        ok(0 === shortener._cmpByList(["D", "C"], "D", "D"), "compares 2");
        ok(0 === shortener._cmpByList(["D", "C"], "C", "C"), "compares 3");
        ok(0 < shortener._cmpByList(["D", "C"], "A", "C"), "compares 4");
        ok(0 > shortener._cmpByList(["D", "C"], "D", "A"), "compares 5");
        ok(0 > shortener._cmpByList(["D", "C"], "D", "C"), "compares 6");
        ok(0 < shortener._cmpByList(["D", "C"], "C", "D"), "compares less");
        ok(0 < shortener._cmpByList(["D", "C"], "c", "D"), "compares less");
        ok(0 > shortener._cmpByList(["D", "C"], "A", "B"), "compares less");
        ok(0 < shortener._cmpByList(["D", "C"], "B", "A"), "compares less");
        ok(0 < shortener._cmpByList(["D", "C"], "a", "A"), "compares less");
        ok(0 > shortener._cmpByList(["D", "C"], "Z", "a"), "compares less");
        ok(0 < shortener._cmpByList(["D", "C"], "a", "Z"), "compares less");
        ok(0 < shortener._cmpByList(["D", "C"], "A", "D"), "compares less");
        ok(0 > shortener._cmpByList(["SAP*", "C"], "SAPABC", "C"), "compares less a");
        ok(0 < shortener._cmpByList(["C", "SAP*"], "SAPABC", "C"), "compares less b");
        ok(0 > shortener._cmpByList(["SAP*", "C"], "SAPABC", "X"), "compares less c");
        ok(0 > shortener._cmpByList(["SAP*", "C"], "SAPABC", "X"), "compares less d");
        ok(0 > shortener._cmpByList(["SAP*", "C"], "SAPA", "SAPB"), "compares less e1");
        ok(0 < shortener._cmpByList(["SAP*", "C"], "SAPB", "SAPA"), "compares less e2");
        ok(0 < shortener._cmpByList(["C", "SAP*"], "SAPABC", "C"), "compares less e");
        ok(0 < shortener._cmpByList(["D", "C"], "A", "D"), "compares less");
        /* eslint-enable yoda */
    });
    ...
    [1, {} , undefined, "AS34567890123456789012345678901234567890"].forEach( function (oFixture) {
    ...
    [1, { a: 1} , 1234,  "AS34567890123456789012345678901234567890"].forEach( function (oFixture, sIndex) {
