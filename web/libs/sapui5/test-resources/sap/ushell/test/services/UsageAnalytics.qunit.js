...
(function () {
    ...
    test("logCustomEvent", function () {
        ...
        var oSrvc = new sap.ushell.services.UsageAnalytics(null, null, oConfig.services.UsageAnalytics);
        oSrvc.setLegalText("bla");
