(function () {
    ...
    sap.ui.controller("sap.ushell.demo.AppNavSample.Main", {
        ...
        _handleNavEvent : function (oEvent) {
            ...
            if (sRouteName === "toaView") {
                ...
                if (/ShowView.*/.test(sViewName)) {
                    // we use this for a specific test that the router of the previous app is correctly
                    // stopped during cross-app navigation
                    // see internal BCP incident 1670239548
                    jQuery.sap.require("sap.m.MessageBox");
                    sap.m.MessageBox.error(
                        "Recieved router event for pattern ShowView* which is used by AppNavSample2." +
            ...
            if (sRouteName === "_home") {
                ...
                // use the startup parameter if we have a view name parameter
        ...
        onInit: function () {
            ...
            var appNavSample2WithInnerRoute = this.oCrossAppNavigator.hrefForExternal({
        ...
        isLegalViewName : function (sViewNameUnderTest) {
            return (typeof sViewNameUnderTest === "string") && (["Detail","View1", "View2", "View3", "View4", "UserDefaultView"].indexOf(sViewNameUnderTest) >= 0);
        },
