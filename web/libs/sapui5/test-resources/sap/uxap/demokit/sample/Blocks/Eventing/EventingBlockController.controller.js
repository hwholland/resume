(function () {
    'use strict';
    jQuery.sap.declare({modName: "sap.uxap.sample.Blocks.Eventing.EventingBlockController", "type": "controller"});

    sap.ui.core.mvc.Controller.extend("sap.uxap.sample.Blocks.Eventing.EventingBlockController", {
