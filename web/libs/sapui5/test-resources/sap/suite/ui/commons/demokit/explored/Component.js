jQuery.sap.declare("sap.suite.ui.commons.explored.Component");

sap.ui.core.UIComponent.extend("sap.suite.ui.commons.explored.Component", {
	...
	init : function () {
		...
		jQuery.sap.require("sap.suite.ui.commons.explored.MyRouter");
		...
		router.myNavBack = sap.suite.ui.commons.explored.MyRouter.myNavBack;
		router.myNavToWithoutHash = sap.suite.ui.commons.explored.MyRouter.myNavToWithoutHash;
