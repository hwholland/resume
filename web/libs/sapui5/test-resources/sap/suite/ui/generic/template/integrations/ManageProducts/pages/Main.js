			...
			assertions: {
				...
				thePageTitleIsCorrect: function() {
					return this.waitFor({
						...
						matchers: new sap.ui.test.matchers.PropertyStrictEquals({
							name: "text",
							value: "Manage Products (Technical Application)"
						}),
						success: function(oTitle) {
							QUnit.ok(oTitle[0].getText() === "Manage Products (Technical Application)", "The main page title is correct.");
						},
				...
				checkCopyWithSupplier: function() {
					return this.waitFor({
						...
						matchers: new sap.ui.test.matchers.PropertyStrictEquals({
							name: "text",
							value: "Copy with new Supplier (Ext)"
						}),
						success: function(oButton2) {
