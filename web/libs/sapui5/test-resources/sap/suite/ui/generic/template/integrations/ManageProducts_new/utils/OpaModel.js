sap.ui.define(["sap/ui/core/util/MockServer", "sap/ui/model/odata/v2/ODataModel"],
	function (MockServer, ODataModel) {
		...
		var getMockModel = function() {
			...
			oMockServer.simulate("../../demokit/sample.stta.manage.products/webapp/localService/metadata.xml", {
				sMockdataBaseUrl: "../../demokit/sample.stta.manage.products/webapp/localService/",
			...
			oModel = new ODataModel("/sap/opu/odata/sap/SEPMRA_PROD_MAN/", {
				...
				annotationURI: [
					"../../demokit/sample.stta.manage.products/webapp/localService/STTA_PROD_MAN_ANNO_MDL.xml",
					"../../demokit/sample.stta.manage.products/webapp/annotations/annotations.xml"
				]
			});
