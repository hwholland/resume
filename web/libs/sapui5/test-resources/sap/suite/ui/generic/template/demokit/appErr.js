...
jQuery.sap.require("demokits/mockFunctions");
					...
					aRequests.push({
							...
							response: function (oXhr, sUrlParams) {
								...
								if (iUrlStatusCode >= 400) {
									...
									oML.log(MS_LOG_TAG_AJAXREQUEST,"jQuery.sap.sjax: GET sUrl:", sUrl);
									var oResponse = jQuery.sap.sjax({
										url: sUrl,
										type: "GET"
									});
									oML.log(MS_LOG_TAG_AJAXRESPONSE, "jQuery.sap.sjax: oResponse:", oResponse);
