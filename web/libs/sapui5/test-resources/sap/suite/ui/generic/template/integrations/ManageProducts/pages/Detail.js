sap.ui.require([
	"sap/ui/test/Opa5", 
	"sap/suite/ui/generic/template/integrations/ManageProducts/pages/Common", 
			...
			actions: {
				...
				clickEdit: function() {
					return this.waitFor({
						...
						success: function(aButtons) {
							aButtons[0].$().trigger("tap");
							QUnit.ok(true, "The Edit button was clicked.");
				...
				clickDelete: function() {
					return this.waitFor({
						...
						matchers: new sap.ui.test.matchers.PropertyStrictEquals({
							name: "id",
							value: "STTA_MP::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--delete"
						}),

						success: function(aButtons) {
							aButtons[0].$().trigger("tap");
							QUnit.ok(true, "The Delete button was clicked.");
...
*/
				...
				checkCopyButton: function() {
					return this.waitFor({
						...
						matchers: new sap.ui.test.matchers.PropertyStrictEquals({
							name: "id",
							value: "STTA_MP::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--action::STTA_PROD_MAN.STTA_PROD_MAN_Entities::STTA_C_MP_ProductCopy"
						}),
						success: function(oButton) {
				...
				checkEditButton: function() {
					return this.waitFor({
						...
						success: function(oButton) {
							QUnit.ok(true, "The detail page has an Edit button.");
						},
