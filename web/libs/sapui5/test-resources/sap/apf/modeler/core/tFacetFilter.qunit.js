...
(function() {
	...
	QUnit.test("Get/Set/Remove automaticSelection", function(assert) {
		assert.equal(this.facetFilter.getAutomaticSelection(), true, "THEN automatic selection is on per default");
	...
	QUnit.test("WHEN Setting preselection defaults", function(assert) {
		assert.equal(this.facetFilter.getAutomaticSelection(), true, "PER DEFAULT automatic selection is on");
