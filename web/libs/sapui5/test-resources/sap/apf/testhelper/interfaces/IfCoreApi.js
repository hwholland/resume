...
sap.apf.testhelper.interfaces.IfCoreApi = function() {
	...
	this.setApplicationCallbackForMessageHandling = function(fnCallback) {
		throw new Error("setApplicationCallbackForMessageHandling not implemented");
	};
	/**
	...
	/**
	 * @description If resetPath has been called with bRememberActualPath, then the old path can be restored.
	 */
	this.restoreOriginalPath = function() {
		throw new Error("restoreOriginalPath not implemented");
	};
	/**
