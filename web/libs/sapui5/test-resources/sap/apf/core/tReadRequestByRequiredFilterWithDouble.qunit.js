...
(function() {
		...
		beforeEach : function(assert) {
			...
			sap.apf.core.Request = function(oInject, oConfig) {
				...
				this.sendGetInBatch = function(oFilter, fnCallback) {
					...
					var oMetadata = oInject.instances.coreApi.getMetadata(oConfig.service);
	...
	QUnit.test("Basic send with a not required filter expression in the context", function(assert) {
		...
		var oReadRequestByRequiredFilter = new sap.apf.core.ReadRequestByRequiredFilter(this.oInject, oRequest, oRequestConfiguration.service, oRequestConfiguration.entityType);
