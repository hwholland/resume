...
QUnit.test('Create, Read, Delete Application', function(assert) {
	...
	var doDeleteApplication = function(sApplication) {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnDeleteApplication, fnErrorDeleteApplication);
	};
	...
	var doReadApplicationAfterUpdate = function(sApplication) {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnReadApplicationAfterUpdate, fnErrorOnReadApplicationAfterUpdate);
	};
	...
	var doUpdateApplication = function(sApplication) {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnUpdateApplication, fnErrorUpdateApplication);
	};
	...
	var doReadAllApplications = function() {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnReadAllApplications, fnErrorOnReadAllApplications);
	};
	...
	var doCreateApplication = function() {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnCreateApplication, fnErrorOnCreateApplication);
	};
	doCreateApplication();
});
...
QUnit.test("Create new Analytical Configuration and read it again", function(assert) {
	...
	var doDeleteApplication = function(sApplication) {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, function() {
	...
	var deleteAnalyticalConfiguration = function(sAnalyticalConfiguration) {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnDeleteAnalyticalConfiguration, fnErrorDeleteAnalyticalConfiguration);
	};
	...
	var readAnalyticalConfigurationAfterModify = function(sAnalyticalConfiguration) {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnReadAnalyticalConfigurationAfterModify, fnErrorOnReadAnalyticalConfiguration);
	};
	...
	var updateAnalyticalConfiguration = function(sAnalyticalConfiguration) {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnUpdateAnalyticalConfiguration, fnErrorUpdateAnalyticalConfiguration);
	};
	...
	var readAnalyticalConfiguration = function(sAnalyticalConfiguration) {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnReadAnalyticalConfiguration, fnErrorOnReadAnalyticalConfiguration);
	};
	...
	var readAllAnalyticalConfigurations = function() {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnReadAllAnalyticalConfigurations, fnErrorOnReadAllAnalyticalConfigurations);
	};
	...
	var createAnalyticalConfiguration = function(sApplication) {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnCreate, fnErrorOnCreate);
	};
	var fnSuccessOnCreateApplication = function(oData, oResponse) {
		if (oData && oData.Application && oResponse.statusText === "Created") {
			assert.ok(true, "Application has been created");
...
QUnit.test("Analytical Configuration Texts - Create/Update in Batch and Delete", function(assert) {
	...
	var doReadAllAnalyticalTextsOfApplication = function() {
		...
		sap.apf.core.odataRequestWrapper(oInject, oRequest, fnSuccessOnReadAllAnalyticalTextsOfApplication, fnErrorOnReadAllAnalyticalTextsOfApplication);
	};
