...
//function createComponentAndApi(oContext, sComponentId) { //TODO put in general helper for integration both doubles and withServer
//	var sId = sComponentId || "Comp1";
//	var oComponent = new sap.apf.Component({
//		id : sId
//	});
//	var sContId = "Comp" + sId;
//	oContext.oCompContainer = new sap.ui.core.ComponentContainer(sContId, {
//		component : oComponent
//	});
//	oContext.oCompContainer.setComponent(oComponent);
//	oContext.oApi = oComponent.getApi();
//};
