...
(function () {
    "use strict";
    /*global asyncTest, deepEqual, equal, except, module, notDeepEqual,
    notEqual, notStrictEqual, ok, opaTest, raises, sinon, start, strictEqual, stop, test,
    jQuery
    */
    jQuery.sap.declare("sap.ca.scfld.stableids.opa.FullscreenTest");
