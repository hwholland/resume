...
(function () {
    "use strict";
    /*global module, notEqual, ok, opaTest, strictEqual, stop, jQuery, sap
    */
    jQuery.sap.declare("sap.ca.scfld.stableids.opa.ScenarioTests");
    ...
    opaTest("Master List Refresh", function (Given, When, Then) {
        ...
        Then.onTheMaster.waitFor({
            ...
            matchers: new sap.ui.test.matchers.Properties({text: "MyButton2"}),
            success: function (aControls) {
                strictEqual(aControls.length, 1, "one Control");
    ...
    opaTest("Window Resizing", function (Given, When, Then) {
        ...
        Then.onTheDetail.waitFor({
            ...
            success: function (aControls) {
                ...
                ok(true, iButtonCount + " Buttons on detail view");
                iWidth = oFrame.width();
                ok(true, iWidth + " original width");
        ...
        Then.onTheDetail.waitFor({
            ...
            success: function (aControls) {
                ...
                ok(iButtonCount3 > iButtonCount2, "Buttons restored");
            },
            errorMessage: "Error"
        });
        Then.iTeardownMyAppFrame();
