...
test("Regression Id4019bf373d32035a8061baa59a436e55f1872ea", function () {
    //english locale
    var formatter = sap.ca.ui.model.format.NumberFormat.getInstance({style:'standard',decimals:2},new sap.ui.core.Locale("en"));
    equal(formatter.format(1234), "1,234.00", "locale en : format(1,234.00) == 1,234.00");

    formatter = sap.ca.ui.model.format.NumberFormat.getInstance({style:'short',shortDecimals:2},new sap.ui.core.Locale("en"));
