	 ...
	 *
	 */
var destroyVizContianer = function(_vizContainer) {
	if (_vizContainer) {
...
/*
 *  function arrayEquaIgnoreSequencel: check if the 2 arrays of data points are the same except for the order of data points
 ...
 */    
 var arrayEquaIgnoreSequencel = function(array1, array2) {
    var hasMap;
...
var createAnalysisObj = function(_analysisindexes)
{
	...
	for(var i=0;i<length;i++)
	{
		...
		{
			var _analysisinfo = new  sap.viz.ui5.controls.common.feeds.AnalysisObject(AnalysisInfo[_analysisindexes[i]]);
...
/**
 * create vizContainer
 * @param {obj} it is json, keyword: layout,enableMorphing,viztype
 *
 */

var createVizContainer = function(_options)
{
	if(arguments.length == 0)
		_options = {};
	//get layout
	if(_options.hasOwnProperty("layout"))
	{
		var layout = _options.layout;
	}else
		var layout = "horizontal";
	//get enableMorphing
	if(_options.hasOwnProperty("enableMorphing"))
	{
		var enableMorphing = _options.enableMorphing;
	}else
		var enableMorphing = true;
	//get viztype
