sap.ui.define(['sap/m/routing/RouteMatchedHandler','sap/ui/core/routing/Router'],
	function(RouteMatchedHandler, Router) {
	"use strict";

	var MyRouter = Router.extend("sap.ui.demo.chartdemo.MyRouter", {
