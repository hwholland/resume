...
sap.ui.define([], function() {
	...
	AnnotationHelper.prototype.getTextArrangement = function(oProperty, oEntityType) {
		var oEnumTextArrangement = null, oPropertyTextAnnotation = null;
		...
		if (oEnumTextArrangement && oEnumTextArrangement.EnumMember) {
			...
			} else if (oEnumTextArrangement.EnumMember === "com.sap.vocabularies.UI.v1.TextArrangementType/TextSeparate") {
				return "idOnly";
			} else if (oEnumTextArrangement.EnumMember === "com.sap.vocabularies.UI.v1.TextArrangementType/TextOnly") {
