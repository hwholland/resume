...
sap.ui.define([
	"jquery.sap.global", "sap/m/Dialog", "sap/m/FlexBox", "sap/m/FlexItemData", "sap/m/Text", "sap/m/Button", "sap/m/DialogType", "sap/ui/core/mvc/XMLView", "sap/ui/comp/smartform/SmartForm", "sap/ui/comp/smartform/Group", "sap/ui/comp/smartform/GroupElement", "sap/ui/comp/odata/FieldSelector", "sap/ui/fl/Utils", "sap/ui/model/json/JSONModel", "sap/ui/fl/FlexControllerFactory", "sap/m/MessageBox", "sap/ui/comp/transport/TransportSelection", "sap/ui/fl/transport/Transports", "sap/ui/fl/registry/Settings", "sap/ui/fl/changeHandler/JsControlTreeModifier"
], function(jQuery, Dialog, FlexBox, FlexItemData, Text, Button, DialogType, XMLView, SmartForm, SmartGroup, SmartField, FieldSelector, FlexUtils, JSONModel, FlexControllerFactory, MessageBox, TransportSelection, Transports, FlexSettings, JsControlTreeModifier) {
	"use strict";
	...
	FormP13nHandler.prototype._createAndApplyChanges = function(aChangeSpecificData) {
		...
		return Promise.resolve().then(function() {
			...
			aChangeSpecificData.filter(fnValidChanges).forEach(function(oChangeSpecificData) {
				var oControl = JsControlTreeModifier.bySelector(oChangeSpecificData.selector);
