...
sap.ui.define(function() {
    ...
    VizFrameOptionsHelper.decorateFiori = function(options, feeds, vizProp) {
        VizFrameOptionsHelper._processCategoryTicker(options, feeds, vizProp);
    }
    ...
    VizFrameOptionsHelper._processCategoryTicker = function(options, feeds, vizProp){
        if (!feeds || feeds.length === 0) {
            return;
        }
