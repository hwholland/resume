    ...
    sap.ushell.iconfonts.registerFiori2IconFont = function () {
        ...
        var oLaunchpadIcons = {
                ...
                icons : [
                    ...
                    ["icon-target-filter", "e0a0"], ["icon-equipment", "E0A1"], ["icon-gis-layer", "E0A2"], ["icon-section", "E0A3"],
                    ["icon-kohorte", "E0A4"], ["icon-female", "E0A5"], ["icon-male", "E0A6"], ["icon-model", "E0A7"],
                    ["icon-hourglass", "E0A8"],["icon-plain-grid-layout","E0A9"],["icon-top-panel-layout","E0AA"],["icon-2x1-grid-layout","E0AB"],
                    ["icon-1x2-grid-layout", "E0AC"],["icon-side-panel-left-layout","E0AD"],["icon-2x2-grid-layout","E0AE"],["icon-inverse-t-layout","E0AF"],
                    ["icon-t-layout", "E0B0"],["icon-top-side-panel-layout","E0B1"],["icon-side-top-panel-layout","E0B2"],["icon-4x4-grid-layout","E0B3"],
                    ["icon-add-point", "E0B4"],["icon-add-polyline","E0B5"],["icon-add-polygone","E0B6"],["icon-email-send-delayed","E0B7"],
                    ["icon-email-not-opened", "E0B8"],["icon-link-not-clicked","E0B9"],["icon-sms-send-delayed","E0BA"],["icon-ab-testing","E0BB"],
                    ["icon-tv", "E0BC"],["icon-radio","E0BD"],["icon-outdoor","E0BE"],["icon-event","E0BF"],
                    ["icon-paid-search", "E0C0"], ["icon-display-ads", "E0C1"], ["icon-call-center", "E0C2"], ["icon-social", "E0C3"],
                    ["icon-event2", "E0C4"], ["icon-official-service-group", "E0C5"], ["icon-time-deposit", "E0C6"], ["icon-early-widthdrawal-for-time-deposits", "E0C7"],
                    ["icon-aggregated-view", "E0C8"], ["icon-detailed-view", "E0C9"], ["icon-rescheduling", "E0CA"], ["icon-resequencing", "E0CB"],
                    ["icon-movement-warning", "E0CC"], ["icon-multiple-warnings", "E0CD"], ["icon-box-truck", "E0CE"], ["icon-box-truck-empty", "E0CF"],
                    ["icon-tractor", "E0C0"], ["icon-driver", "E0D1"], ["icon-driver-warning", "E0D2"], ["icon-overlap", "E0D3"],
                    ["icon-expand-overlap", "E0D4"], ["icon-collapse-overlap", "E0D5"], ["icon-utilization", "E0D6"], ["icon-expand-utilization", "E0D7"],
                    ["icon-collapse-utilization", "E0D8"], ["icon-trailer", "E0D7"], ["icon-container-closed", "E0DA"], ["icon-railcar", "E0DB"],
                    ["icon-warehouse", "E0DC"], ["icon-goods", "E0DD"], ["icon-ship", "E0DE"], ["icon-truck-driver", "E0DF"],
                    ["icon-logistics", "E0E0"], ["icon-in-return", "E0E1"], ["icon-in-contract", "E0E2"],
            ...
            oTNTIcons = {
                ...
                icons: [
                    ...
                    ["Database Consistency", "e00b"], ["Intermediate Message", "e00c"], ["Exceptions", "e00d"], ["Python", "e00f"],
                    ["Raise fault", "e010"], ["Code1", "e011"], ["Code2", "e012"], ["Spike arrest", "e013"],
                    ["Verify API", "e014"], ["User", "e015"], ["Note", "e016"], ["Throwing message", "e017"],
                    ["Catching message", "e018"], ["Start event", "e019"], ["End event", "e01a"], ["Gateway", "e01b"],
                    ["Sub process marker", "e01c"], ["Ad hoc marker", "e01d"], ["Manual task", "e01e"], ["Send task", "e01f"],
                    ["Receive task", "e020"], ["Script task", "e021"], ["Marquee", "e022"], ["Data input arrow", "e023"],
                    ["Data output arrow", "e024"], ["More", "e025"], ["Pattern", "e026"], ["Task", "e027"],
                    ["Arrow", "e028"], ["Data", "e029"], ["Data store", "e02a"], ["Pool", "e02b"],
                    ["Swimlane", "e02c"], ["Select", "e02d"]
            ...
            oFioriInApp = {
                ...
                icons : [
                    ...
                    ["Snow", "e71D"], ["Risk Assessment", "e71E"]
                ]
            },
            oFioriNonNative = {
                fontFamily: "Fiori2",
