...
sap.ui.require([
  ...
  QUnit.module("Opa5 Test Harness Tests", {
    ...
    beforeEach : function() {
      ...
      this.fMockOpa5Teardown = function() {
      ...
      testHarnessTests.beforeEach(this.fMockOpa5Setup, this.fMockOpa5Teardown, opa5TestHarness);
    },
