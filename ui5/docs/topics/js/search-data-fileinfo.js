...
"Create apps with rich user interfaces for modern web business applications, responsive across browsers and devices, based on HTML5. (Documentation version 1.54.3)",
...
"Used for modifying OpenUI5. The environment is based on Node.js, used as a server, with a build process that is based on Grunt. This section provides information for the initial setup, development workflow, and tests execution.",
...
"With this release the UI development toolkit for HTML5 (OpenUI5) is upgraded from version 1.52 to 1.54.",
