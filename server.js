...
oApp.use("/ui5", serveIndex(__dirname + "/ui5", {icons: true}));
oApp.use("/ui5", express.static(__dirname + "/ui5"));
oApp.use("/sapui5", serveIndex(__dirname + "/sapui5", {icons: true}));
oApp.use("/sapui5", express.static(__dirname + "/sapui5"));
