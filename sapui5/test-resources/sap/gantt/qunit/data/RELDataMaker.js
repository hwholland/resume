...
(function (window) {
	...
	function RELDataMaker(sHierarchyId, oTimePattern, oInterval, oCalendarPattern, oUtil) {
		sap.gantt.DataMaker.call(this, sHierarchyId, oTimePattern, oInterval, oCalendarPattern, oUtil);
	}
	RELDataMaker.prototype = new sap.gantt.DataMaker();
	...
	RELDataMaker.prototype.makeData = function() {
		...
		this.addRow("root", "relationship_0", {"text": "TC_Relationship_Display", 
			"status": 1,
			"type": "TOL",
			"id": "0048",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_0", {"text": "Task 1", 
				"status": 1,
				"id": "0049",
				"type": "TOL",
				"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_01", {"text": "Task 2", 
			"status": 1,
			"id": "0050",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0_01", "relationship_0_01_0", {"text": "Task 1.1", 
			"status": 1,
			"id": "0057",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_02", {"text": "Task 3", 
			"status": 1,
			"id": "0051",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_03", {"text": "Task 4", 
			"status": 1,
			"id": "0052",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_04", {"text": "Task 5", 
			"status": 1,
			"id": "0053",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_05", {"text": "Task 6", 
			"status": 1,
			"id": "0054",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_06", {"text": "Task 7", 
			"status": 1,
			"id": "0055",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_07", {"text": "Task 8", 
			"status": 1,
			"id": "0056",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_08", {"text": "Task 9", 
			"status": 1,
			"id": "0058",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_09", {"text": "Task 10", 
			"status": 1,
			"id": "0059",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_1", {"text": "Task 11", 
			"status": 1,
			"id": "0149",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_11", {"text": "Task 12", 
			"status": 1,
			"id": "0150",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0_11", "relationship_0_11_0", {"text": "Task 11.1", 
			"status": 1,
			"id": "0157",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_12", {"text": "Task 13", 
			"status": 1,
			"id": "0151",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_13", {"text": "Task 14", 
			"status": 1,
			"id": "0152",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_14", {"text": "Task 15", 
			"status": 1,
			"id": "0153",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_15", {"text": "Task 16", 
			"status": 1,
			"id": "0154",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_16", {"text": "Task 17", 
			"status": 1,
			"id": "0155",
			"type": "TOL",
			"selected": false,
		...
		this.addRow("relationship_0", "relationship_0_17", {"text": "Task 18", 
			"status": 1,
			"id": "0156",
			"type": "TOL",
			"selected": false,
	...
	window.sap.gantt.RELDataMaker = window.sap.gantt.RELDataMaker || RELDataMaker;
})(window);
