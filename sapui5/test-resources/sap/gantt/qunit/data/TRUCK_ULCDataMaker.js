...
(function (window) {
	...
	TRUCKULCDataMaker.prototype.makeData = function () {
		...
		this.addRow("root", "01_1", {"text": "truck01_1",
				"plate": "EF20112",
	...
	window.sap.gantt.TRUCKULCDataMaker = window.sap.gantt.TRUCKULCDataMaker || TRUCKULCDataMaker;
})(window);
