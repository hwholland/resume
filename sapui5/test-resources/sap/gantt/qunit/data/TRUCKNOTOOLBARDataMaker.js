...
(function (window) {
	...
	TRUCKNOTOOLBARDataMaker.prototype.makeData = function () {
		...
		this.addRow("truck_0", "truck_0_0", {"uuid": "sub_01_0_1",
            "name": "Ethan",
            "id": "00001",
            "type": "04",
            "selected": false});
		...
		this.addRow("root", "truck_01", {"text": "truck01_1",
			"plate": "HA12345",
		...
		this.addRow("truck_01", "truck_01_0", { "text": "sub_01_1_1",
			"plate": "G54321",
		...
		this.addRow("truck_01", "truck_01_1", { "text": "sub_01_1_2",
            "name": "Patric",
            "id": "00012",
            "type": "04",
            "selected": false});
		...
		this.addRow("root", "truck_02", {"text": "01_2",
        "plate": "SJ29384",
        "plate_expire": "20211409000000",
        "id": "0002",
        "type": "01",
		...
		this.addRow("root", "truck_03", {"text": "01_3",
        "plate": "HC29986",
		...
		this.addRow("truck_03", "truck_03_0", {"text": "sub_01_3_1",
            "name": "Martin",
            "id": "00031",
            "type": "04",
            "selected": false});
		...
		this.addRow("truck_03_0", "truck_03_0_0", { "text": "sub_sub_01_3_1",
                "name": "Martin 2",
                "id": "000311",
                "type": "04",
                "selected": false});
		...
		this.addRow("truck_03_0", "truck_03_0_1", {"text": "sub_01_3_2",
            "plate": "LU-98376",
            "id": "00032",
            "type": "02",
            "selected": false});
		...
		this.addRow("root", "truck_04", {"text": "01_4",
        "plate": "HE-98763",
		...
		this.addRow("root", "truck_05", {"text": "01_5",
        "plate": "J-A00000",
		...
		this.addRow("truck_05", "truck_05_0", {"text": "sub_01_5_1",
            "name": "Robin_1",
            "id": "00051",
            "type": "03",
            "selected": false});
		...
		this.addRow("truck_05_0", "truck_05_0_0", {"text": "sub_sub_01_5_1",
                "name": "Robin_2",
                "id": "000511",
                "type": "04",
                "selected": false});
		...
		this.addRow("truck_05_0", "truck_05_0_1", {"text": "sub_01_5_2",
            "plate": "HA-87652",
            "plate_expire": "20300706000000",
            "id": "00052",
            "type": "02",
		...
		this.addRow("root", "truck_06", {"text": "01_6",
        "plate": "Y-827663",
        "id": "0006",
        "type": "01",
        "subType": "01",
		...
		this.addRow("root", "truck_07", {"text": "01_7",
        "plate": "W-977662",
        "plate_expire": "20300706000000",
        "id": "0007",
        "type": "01",
	...
	window.sap.gantt.TRUCKNOTOOLBARDataMaker = window.sap.gantt.TRUCKNOTOOLBARDataMaker || TRUCKNOTOOLBARDataMaker;
})(window);
