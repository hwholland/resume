...
(function (window) {
	...
	TRUCKDataMaker.prototype = new sap.gantt.DataMaker();
	...
	TRUCKDataMaker.prototype.makeData = function (){
		...
		this.addRow("root", "truck_02", {"text": "truck01_2",
			"plate": "EF21110",
		...
		this.addRow("root", "truck_03", {"text": "truck01_3",
				"plate": "EF20115",
		...
		this.addRow("root", "truck_04", {"text": "truck01_4",
				"plate": "EG20110",
		...
		this.addRow("root", "truck_05", {"text": "truck01_5",
				"plate": "EF23110",
		...
		this.addRow("root", "truck_06", {"text": "truck01_6",
				"plate": "EF20117",
		...
		this.addRow("root", "truck_07", {"text": "truck01_7",
				"plate": "EF20120",
		...
		this.addRow("root", "truck_08", {"text": "truck01_8",
				"plate": "EF20120",
				"plate_expire": "20210305000000",
				"id": "0008",
				"type": "01",
		...
		this.addRow("root", "truck_09", {"text": "truck01_9",
				"plate": "EF20120",
				"plate_expire": "20210305000000",
				"id": "0009",
				"type": "01",
		...
		this.addRow("root", "truck_10", {"text": "truck01_10",
				"plate": "EF20120",
				"plate_expire": "20210305000000",
				"id": "00010",
				"type": "01",
		...
		this.addRow("root", "truck_11", {"text": "truck01_11",
				"plate": "EF20120",
				"plate_expire": "20210305000000",
				"id": "00011",
				"type": "01",
		...
		this.addCalendarToHierarchy("twoDaysAWeek", 20, {"startTime": "20140920000000",
						"endTime": "20141012000000"});
	...
	window.sap.gantt.TRUCKDataMaker = window.sap.gantt.TRUCKDataMaker || TRUCKDataMaker;
})(window);
