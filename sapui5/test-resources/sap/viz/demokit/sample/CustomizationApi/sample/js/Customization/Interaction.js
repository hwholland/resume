define(['sap/viz/framework/common/util/TypeUtils'], function(TypeUtils) {
    ...
    InteractionCustomization.prototype.handle = function(id, event, vizModelInfo, vizRenderInfo) {
        console.log('InteractionCustomization.prototype.handler: ' + id);
    ...
    */
    var _appendInteractionNode = function(renderInfos, layer){
        ...
        if(TypeUtils.isArray(renderInfos)){// Array
            if(renderInfos && renderInfos.length>0){
                if(TypeUtils.isArray(renderInfos[0])){ // 2D array
