...
(function () {
    ...
    test("ActionItem default actionType Test", function () {
        ...
        ok(actionItem.hasStyleClass('sapUshellActionItem') === false, 'by default no class is added');
    });
    ...
    test("ActionItem 'action' actionType Test", function () {
        ...
        ok(actionItem.hasStyleClass('sapUshellActionItem') === true, 'sapUshellActionItem class added');
    ...
    test("ActionItem change actionType Test", function () {
        ...
        ok(actionItem.hasStyleClass('sapUshellActionItem') === false, 'sapUshellActionItem class removed');
