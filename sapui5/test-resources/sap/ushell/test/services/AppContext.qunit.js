 ...
 * This is a 2nd test suite for a new version of the Personalization
 * suite functionality,
 * Note that this uses getContainer  delContainer interface(!) which returns
 * objects with a different semantic (!)
 */
(function () {
    "use strict";

    /*jslint nomen: true*/
    /*global asyncTest, QUnit, deepEqual, equal, module, ok, start, stop, test, sinon, jQuery, sap, assert */
    ...
    test("AppContainerVariant: create a variant with a non-string key", function () {
        ...
        try {
            var oVariant = new sap.ushell.services.PersonalizationContainerVariant(sVariantKey, sVariantName, {});
            oVariant = oVariant; // eslint
...
// No check for JSON
//    test("AppContainerVariant: create  variant with variant data not being a JSON object", function () {
//        var oVariant = {},
//            sVariantKey = "",
//            sVariantName = "",
//            oVariantData = {};
...
//        sVariantKey = "0";
//        sVariantName = "VariantName";
//        oVariantData = ["not a JSON"];
//        try {
//            oVariant = new sap.ushell.services.PersonalizationContainerVariant(sVariantKey, sVariantName, oVariantData);
//            ok(false, "Upps, variant does not care of what is the data");
//        } catch (c) {
//            ok(true, "Variant needs at least an object as oVariantData");
//        }
//    });
    ...
    // ........... Container Item Tests ...........
        ...
        test("AppContainerVariant (" + oFixture.validity + "): set variant name - variant does not exist in variant set", function (asser) {
            var sVARIANT_SET_KEY = "VARIANT_SET_KEY_999",
                sORIGINAL_VARIANT_NAME = "Original variant name",
                sNEW_VARIANT_NAME = "New variant name",
                sVariantKey,
        ...
        test("AppContainerVariant (" + oFixture.validity + "): set variant name - new variant already exists", function (assert) {
            ...
            QUnit.assert.equal(true, this.oContainerVSAdapter.containsVariantSet(sVARIANT_SET_KEY),
                    "Variant set '" + sVARIANT_SET_KEY + "' was added");
            oVariant1 = oVariantSet.addVariant(sORIGINAL_VARIANT_NAME);
            oVariant2 = oVariantSet.addVariant(sNEW_VARIANT_NAME);
