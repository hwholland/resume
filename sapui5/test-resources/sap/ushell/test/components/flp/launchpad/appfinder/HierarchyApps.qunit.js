// @copyright@
/**
 * @fileOverview QUnit tests for sap.ushell.components.flp.launchpad.appfinder.HierarchyApps
 */
(function () {
    "use strict";
    ...
    module("sap.ushell.components.flp.launchpad.appfinder.HierarchyApps", {
        setup: function () {
            sap.ushell.bootstrap("local");
            oController = new sap.ui.controller("sap.ushell.components.flp.launchpad.appfinder.HierarchyApps");
        },
        /**
    ...
    function _testHandleBookmarkAppPopoverResponse (oMockApp, oMockPopoverResponse, bResolveCreateGroup, bResolveAddBookmark, bExpectedSuccess) {
        ...
        fCreateGroupStub = sinon.stub(oDashboardManager, "createGroup", function() {
