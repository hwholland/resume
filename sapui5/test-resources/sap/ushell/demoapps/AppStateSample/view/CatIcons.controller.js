...
(function () {
     ...
     *
     * @returns {int}
     *   Returns the total number of icon entries of all collections together
     *
     * @private
     */
     ...
     *   The collection or category name of the icons
     * @param {number} nIdxStart
     *   You can pass the start index for the rows
     * @returns {string[]}
     *   Returns the prepared table rows for the given collection name
     *
     * @private
     */
     ...
     *
     * @param {string} sCollectionName
     *   Name of icon collection/category (e.g. 'undefined', 'Fiori2')
     * @returns {string[]}
     *   Returns the prepared table rows for the given collection name
     *
     * @private
