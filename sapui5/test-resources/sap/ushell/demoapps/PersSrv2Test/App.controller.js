...
/*jslint nomen: true */
// this application creates/reads/deletes multiple records in the Personalization service
// the used key 
(function () {
    "use strict";
    ...
    sap.ui.controller(
        "sap.ushell.demo.PersSrv2Test.App",
        {
            onInit : function () {
                var sSrvURL;
...
//                    "NoRecords" : "100",
            ...
            /**
             * Called when "New" button in the Container life cycle test panel is
             * pressed
             */
            ...
            savePersCOContainer : function (sKey, fndone) {
                ...
                //this.oDataModel.create("/containers", obj, fndone, this.errorSubmitBatch);
            ...
            /**
             * Called when "Load" button in the Container life cycle test panel is
             * pressed
             */
            ...
            /**
             * Called when "Save" button in the Container life cycle test panel is
             * pressed
             */
            ...
            /**
             * Called when "Delete" button in the Container life cycle test panel is
             * pressed
             */
...
//                this._clearContainerWorkaround();
