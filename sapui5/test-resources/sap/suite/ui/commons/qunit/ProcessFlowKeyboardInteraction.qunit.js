QUnit.module("ProcessFlowKeyboardInteraction - Basic Tests", {
  beforeEach: function () {
    var oDataCC2 = {
      nodes:
        [
          ...
          { id: "43", lane: "id4", title: "11Payment Document 65945539 [4,9]", children: [52, 53, 54, 56], state: sap.suite.ui.commons.ProcessFlowNodeState.Positive },
          { id: "44", lane: "id4", title: "12Payment Document 9004562 [0,9]", children: [55], state: sap.suite.ui.commons.ProcessFlowNodeState.Positive },
          { id: "51", lane: "id5", title: "13Acceptance Letter 45784561 [2, 11]", children: null, state: sap.suite.ui.commons.ProcessFlowNodeState.Positive },
    ...
    var oJModelCC2 = new sap.ui.model.json.JSONModel(oDataCC2);
    this.oProcessFlowCC2 = new sap.suite.ui.commons.ProcessFlow("pComplexCase2", {
      foldedCorners: true,
      nodes: {
        path: "/nodes",
...
QUnit.test("Move focus based on arrow - check movement function to left", function (assert) {
  ...
  var bMovePossible = this.oProcessFlowCC2._moveToNextElement(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.RIGHT);
...
QUnit.test("Move focus based on arrow - check movement to the left same line", function (assert) {
  ...
  this.oProcessFlowCC2.updateModel();
  // the tab key is pressed
  var bMovePossible = this.oProcessFlowCC2._moveToNextElement(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.LEFT);
  //the node 10 should be focused, the node 1 is unfocused
...
QUnit.test("Move focus based on arrow - check movement one up single case", function (assert) {
  ...
  this.oProcessFlowCC2.updateModel();
  // the tab key is pressed
  var bMovePossible = this.oProcessFlowCC2._moveToNextElement(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.UP);
  //the node 10 should be focused, the node 1 is unfocused
...
QUnit.test("Move focus based on arrow - check movement one down single case", function (assert) {
  ...
  this.oProcessFlowCC2.updateModel();
  // the tab key is pressed
  var bMovePossible = this.oProcessFlowCC2._moveToNextElement(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.DOWN);
  //the node 10 should be focused, the node 1 is unfocused
...
QUnit.test("Move focus based on HOME - check movement to the first item in the same row", function (assert) {
  ...
  this.oProcessFlowCC2.updateModel();
  // the tab key is pressed
  var bMovePossible = this.oProcessFlowCC2._moveHomeEnd(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.LEFT);
...
QUnit.test("Move focus based on CTRL HOME - check movement to the first item in the same column", function (assert) {
  ...
  this.oProcessFlowCC2.updateModel();
  // the tab key is pressed
  var bMovePossible = this.oProcessFlowCC2._moveHomeEnd(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.LEFT, true);
...
QUnit.test("Move focus based on END - check movement to the last item in the same row", function (assert) {
  ...
  this.oProcessFlowCC2.updateModel();
  // the tab key is pressed
  var bMovePossible = this.oProcessFlowCC2._moveHomeEnd(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.RIGHT);
...
QUnit.test("Move focus based on CTRL END - check movement to the last item in the same column", function (assert) {
  ...
  this.oProcessFlowCC2.updateModel();
  // the tab key is pressed
  var bMovePossible = this.oProcessFlowCC2._moveHomeEnd(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.RIGHT, true);
...
QUnit.test("Move focus based on PAGEUP - check movement to minus 5 columns", function (assert) {
  ...
  this.oProcessFlowCC2.updateModel();
  // the tab key is pressed
  var bMovePossible = this.oProcessFlowCC2._moveOnePage(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.UP, false);
...
QUnit.test("Move focus based on ALT PAGEUP - check movement to minus 5 to the left", function (assert) {
  ...
  this.oProcessFlowCC2.updateModel();
  // the tab key is pressed
  var bMovePossible = this.oProcessFlowCC2._moveOnePage(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.UP, true);
...
QUnit.test("Move focus based on PAGEDOWN - check movement to plus 5 columns", function (assert) {
  ...
  this.oProcessFlowCC2.updateModel();
  // the tab key is pressed
  var bMovePossible = this.oProcessFlowCC2._moveOnePage(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.DOWN, false);
  assert.ok(nodes[18]._getNavigationFocus(), "First element in row focus");
...
QUnit.test("Move focus based on ALT PAGEUP - check movement to minus 5 to the right", function (assert) {
  ...
  this.oProcessFlowCC2.updateModel();
  // the tab key is pressed
  var bMovePossible = this.oProcessFlowCC2._moveOnePage(sap.suite.ui.commons.ProcessFlow._enumMoveDirection.DOWN, true);
  assert.ok(nodes[17]._getNavigationFocus(), "First element in row focus");
...
QUnit.module("ProcessFlowKeyboardInteraction - Testcases for keyboard interaction", {});
  ...
  function buildProcessFlow(idx) {
    var oProcessFlow = new sap.suite.ui.commons.ProcessFlow("keyboardPF" + idx, {
      nodes: {
        path: "/nodes",
        template: new sap.suite.ui.commons.ProcessFlowNode({
          nodeId: "{id}",
    ...
    var oJModel = new sap.ui.model.json.JSONModel(jQuery.extend(true, {}, oData));
...
QUnit.test("Check the keyboard event on processflow chart - ENTER", function (assert) {
  ...
  qutils.triggerKeyboardEvent(aNodes[0].getDomRef(), jQuery.sap.KeyCodes.ENTER);
...
QUnit.test("Check the keyboard event on processflow chart - SPACE", function (assert) {
  ...
  qutils.triggerKeyboardEvent(aNodes[0].getDomRef(), jQuery.sap.KeyCodes.SPACE);
  oProcessFlow.destroy();
});
