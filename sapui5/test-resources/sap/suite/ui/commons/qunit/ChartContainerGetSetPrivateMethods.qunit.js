QUnit.module("Getter/Setter private methods", {
	beforeEach : function() {
		var oVizFrame = new sap.viz.ui5.controls.VizFrame("vizFrameGetterSetterMethods");
		this.oVizFrameContent = new sap.suite.ui.commons.ChartContainerContent("chartContainerContent",{
			content : oVizFrame
		});
		this.oChartContainer = new sap.suite.ui.commons.ChartContainer("chartContainerGetterSetterMethods", {
...
QUnit.test("_toggleShowLegendButtons set the selected button when chart is visible", function(assert) {
	...
	var oChartContainer = this.oChartContainer._toggleShowLegendButtons(oChart);
...
QUnit.test("_setDefaultOnSegmentedButton sets selected button if none is set", function(assert) {
	...
	var oChartContainer = this.oChartContainer._setDefaultOnSegmentedButton();
