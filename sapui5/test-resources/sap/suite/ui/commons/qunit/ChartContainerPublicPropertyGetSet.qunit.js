QUnit.module("Public property getters/setters", {
	beforeEach : function() {
		this.oVizFrameContent = new sap.suite.ui.commons.ChartContainerContent("chartContainerContentPropertyGettersSetters",{
			content : new sap.viz.ui5.controls.VizFrame("vizFramePropertyGettersSetters")
		});
		this.oChartContainer = new sap.suite.ui.commons.ChartContainer("chartContainerPropertyGettersSetters", {
