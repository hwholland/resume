QUnit.module("Existence of SegmentedButton container depending on the number of charts in ChartContainer", {
	beforeEach : function() {
		this.oVizFrame = new sap.viz.ui5.controls.VizFrame();
		this.oVizFrame2 = this.oVizFrame.clone();
		this.oVizFrame3 = this.oVizFrame.clone();

		this.oContent1 = new sap.suite.ui.commons.ChartContainerContent({
			icon : "sap-icon://horizontal-bar-chart",
			title : "vizFrame Bar Chart Sample",
			content : this.oVizFrame
		});
		this.oContent2 = new sap.suite.ui.commons.ChartContainerContent({
			icon : "sap-icon://line-chart",
			title : "vizFrame Line Chart Sample",
			content : this.oVizFrame2
		});
		this.oContent3 = new sap.suite.ui.commons.ChartContainerContent({
			icon : "sap-icon://line-chart",
			title : "vizFrame Line Chart Sample",
...
QUnit.module("Proper initialization of ScrollEnablement depending on the type of content displayed", {
	beforeEach : function() {
		this.oVizFrameContent = new sap.suite.ui.commons.ChartContainerContent({
			content : new sap.viz.ui5.controls.VizFrame()
		});
		this.oTableContent = new sap.suite.ui.commons.ChartContainerContent({
