QUnit.module("ProcessFlowNodeElement - Basic tests", {
  beforeEach: function () {
    ...
    this.laneHeader0 = new sap.suite.ui.commons.ProcessFlowLaneHeader({
      laneId: "0",
      position: 0
    });

    this.laneHeader1 = new sap.suite.ui.commons.ProcessFlowLaneHeader({
      laneId: "1",
      position: 1
    });

    this.laneHeader2 = new sap.suite.ui.commons.ProcessFlowLaneHeader({
      laneId: "2",
      position: 2
    });

    this.laneHeader3 = new sap.suite.ui.commons.ProcessFlowLaneHeader({
      laneId: "3",
      position: 3
    });

    this.laneHeader4 = new sap.suite.ui.commons.ProcessFlowLaneHeader({
      laneId: "4",
      position: 4
    });

    this.pfNode1 = new sap.suite.ui.commons.ProcessFlowNode({
      id: "processFlowNode1",
      nodeId: "1",
      laneId: "0",
    ...
    this.pfNode2 = new sap.suite.ui.commons.ProcessFlowNode({
      id: "processFlowNode2",
      nodeId: "10",
      laneId: "4",
      title: "title10",
    ...
    this.pfNode3 = new sap.suite.ui.commons.ProcessFlowNode({
      id: "processFlowNode3",
      nodeId: "11",
      laneId: "3",
      title: "title11",
    ...
    this.pfNode4 = new sap.suite.ui.commons.ProcessFlowNode({
      id: "processFlowNode4",
      nodeId: "12",
      laneId: "2",
      title: "title12",
    ...
    this.pfNode5 = new sap.suite.ui.commons.ProcessFlowNode({
      id: "processFlowNode5",
      nodeId: "5",
      laneId: "3",
      title: "title5",
    ...
    /*
        this.arrNode[this.pfNode1.nodeId] = this.pfNode1;
        this.arrNode[this.pfNode2.nodeId] = this.pfNode2;
        this.arrNode[this.pfNode3.nodeId] = this.pfNode3;
        this.arrNode[this.pfNode4.nodeId] = this.pfNode4;
        this.arrNode[this.pfNode5.nodeId] = this.pfNode5;
  */
    this.lanes = [];
    ...
    /*
    this.lanes[this.laneHeader0] = this.laneHeader0;
    this.lanes[this.laneHeader1] = this.laneHeader1;
    this.lanes[this.laneHeader2] = this.laneHeader2;
    this.lanes[this.laneHeader3] = this.laneHeader3;
    this.lanes[this.laneHeader4] = this.laneHeader4;
    */
  },
  afterEach: function () {
    if (this.processFlow) {
...
QUnit.test("Create nodes with wrong children definition - not with an existing child", function (assert) {
  ...
  var internalMatrix = new sap.suite.ui.commons.ProcessFlow.InternalMatrixCalculation();
  var internalMap = {};
...
QUnit.test("create map from nodes - createNodeElementsFromProcessFlowNodes null lane input", function (assert) {
  assert.throws(function () {
    sap.suite.ui.commons.ProcessFlow.NodeElement
    ._createNodeElementsFromProcessFlowNodes(this.arrNode, null).elementById;
  },
...
QUnit.test("create map from nodes - createNodeElementsFromProcessFlowNodes happy case",
    function (assert) {
      var mapResult = sap.suite.ui.commons.ProcessFlow.NodeElement
          ._createNodeElementsFromProcessFlowNodes(this.arrNode, this.lanes).elementById;
      ...
      for (var i = 0; i < this.arrNode.length; i++) {
        ...
        assert.ok(singleElem instanceof sap.suite.ui.commons.ProcessFlow.NodeElement,
...
QUnit.test("create map from nodes - createNodeElementsFromProcessFlowNodes empty input", function (assert) {
  var arrMap = sap.suite.ui.commons.ProcessFlow.NodeElement
...
QUnit.test("calculate _calculateLaneStatePieChart happy test case regular nodes", function (assert) {
  var tempLanes = this.lanes.slice();
  var arrNodes = [];
  arrNodes.push(new sap.suite.ui.commons.ProcessFlowNode({
    id: "lanepiechart1",
    nodeId: "1",
    laneId: "3",
  }));
  ...
  var mapLaneToNode = sap.suite.ui.commons.ProcessFlow.NodeElement
          ._createNodeElementsFromProcessFlowNodes(arrNodes, this.lanes).elementsByLane;
  sap.suite.ui.commons.ProcessFlow.NodeElement._calculateLaneStatePieChart(mapLaneToNode, tempLanes, arrNodes, this.processFlow);
...
QUnit.test("calculate _calculateLaneStatePieChart null input for nodes", function (assert) {
  sap.suite.ui.commons.ProcessFlow.NodeElement
       ._createNodeElementsFromProcessFlowNodes({}, this.lanes);
...
QUnit.test("calculate _calculateLaneStatePieChart null input for lanes", function (assert) {
  ...
  sap.suite.ui.commons.ProcessFlow.NodeElement
          ._calculateLaneStatePieChart(mapLaneToNode, null, this.arrNode);
...
QUnit.test("calculate _calculateLaneStatePieChart null input for map", function (assert) {
  ...
  sap.suite.ui.commons.ProcessFlow.NodeElement
          ._calculateLaneStatePieChart(null, tempLanes, null);
  assert.ok(tempLanes, "Lanes exist");
});