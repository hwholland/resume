QUnit.module("Public aggregation getters/setters", {
	beforeEach : function() {
		this.oVizFrameContent = new sap.suite.ui.commons.ChartContainerContent("chartContainerContentAggregationGettersSetters",{
			content : new sap.viz.ui5.controls.VizFrame("vizFrameAggregationGettersSetters")
		});
		this.oChartContainer = new sap.suite.ui.commons.ChartContainer("chartContainerAggregationGettersSetters", {
...
QUnit.test("DestroyDimensionSelectors destroys all available dimension selectors", function(assert) {
	...
	var spy_removeContent = sinon.spy();
	var oToolbar = {
		removeContent: spy_removeContent
	};
	...
	assert.ok(spy_removeContent.called, "removeContent on toolbar called");
...
QUnit.test("RemoveDimensionSelector removes the specified dimension selector", function(assert) {
	...
	var spy_indexOfDimensionSelector = sinon.spy(this.oChartContainer, "indexOfDimensionSelector");

	var sRemovedDimensionSelector = this.oChartContainer.removeDimensionSelector(sDimensionSelector);

	assert.ok(spy_removeContent.called, "removeContent on toolbar called");
	assert.ok(spy_removeContent.calledWith(sDimensionSelector), "removeContent on toolbar called with the passed dimension selector");
	assert.ok(spy_indexOfDimensionSelector.called, "indexOfDimensionSelector called");
	assert.ok(spy_indexOfDimensionSelector.calledWith(sDimensionSelector), "indexOfDimensionSelector called with the passed dimension selector");
	...
	spy_indexOfDimensionSelector.restore();
...
QUnit.test("RemoveDimensionSelector returns null if no dimension selector is passed", function(assert) {
	...
	assert.ok(spy_indexOfDimensionSelector.notCalled, "indexOfDimensionSelector not called");
	assert.equal(removedDimensionSelector, null, "Null is returned");
...
QUnit.test("RemoveAllDimensionSelectors removes all dimension selectors", function(assert) {
	...
	assert.ok(spy_removeContent.called, "removeContent on toolbar called");
	assert.ok(spy_removeContent.calledTwice, "removeContent called twice");
	assert.ok(spy_removeContent.calledWith("dummy1"), "removeContent on toolbar called with the first dimension selector");
	assert.ok(spy_removeContent.calledWith("dummy2"), "removeContent on toolbar called with the second dimension selector");
	assert.equal(0, this.oChartContainer._aDimensionSelectors.length, "dimension selector array is empty");
...
QUnit.test("AddAggregation calls addDimensionSelector for dimensionSelectors", function(assert) {
	...
	var stubAddAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "addAggregation");
...
QUnit.test("AddAggregation calls addAggregation for non-dimensionSelectors", function(assert) {
	...
	var stubAddAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "addAggregation").returns(sReturnValue);
...
QUnit.test("GetAggregation calls getDimensionSelectors for dimensionSelectors", function(assert) {
	...
	var stubGetAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "getAggregation");
...
QUnit.test("GetAggregation calls getAggregation for non-dimensionSelectors", function(assert) {
	...
	var stubGetAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "getAggregation").returns(sReturnValue);
...
QUnit.test("IndexOfAggregation calls getDimensionSelectors for dimensionSelectors", function(assert) {
	...
	var stubIndexOfAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "indexOfAggregation");
...
QUnit.test("IndexOfAggregation calls getAggregation for non-dimensionSelectors", function(assert) {
	...
	var stubIndexOfAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "indexOfAggregation").returns(sReturnValue);
...
QUnit.test("InsertAggregation calls getDimensionSelectors for dimensionSelectors", function(assert) {
	...
	var stubInsertAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "insertAggregation");
...
QUnit.test("InsertAggregation calls getAggregation for non-dimensionSelectors", function(assert) {
	...
	var stubInsertAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "insertAggregation").returns(sReturnValue);
...
QUnit.test("DestroyAggregation calls destroyDimensionSelectors for dimensionSelectors", function(assert) {
	...
	var stubDestroyAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "destroyAggregation");
...
QUnit.test("DestroyAggregation calls getAggregation for dimensionSelectors", function(assert) {
	...
	var stubDestroyAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "destroyAggregation").returns(sReturnValue);
...
QUnit.test("RemoveAggregation calls removeAggregation for dimensionSelectors", function(assert) {
	...
	var stubRemoveAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "removeAggregation");
...
QUnit.test("RemoveAggregation calls getAggregation for non-dimensionSelectors", function(assert) {
	...
	var stubRemoveAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "removeAggregation").returns(sReturnValue);
...
QUnit.test("RemoveAllAggregation calls removeAllDimensionSelectors for non-dimensionSelectos", function(assert) {
	...
	var stubRemoveAllAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "removeAllAggregation");
...
QUnit.test("RemoveAllAggregation calls removeAllAggregation for dimensionSelectors", function(assert) {
	...
	var stubRemoveAllAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "removeAllAggregation").returns(sReturnValue);
...
QUnit.test("RemoveAllAggregation with the argument content removes all content from the content aggregation", function(assert) {
	...
	stubRemoveAllAggregation = sinon.stub(sap.ui.base.ManagedObject.prototype, "removeAllAggregation");
