sap.ui.controller("sap.suite.ui.commons.sample.ChartContainerDimensionsMultiCharts.ChartContainer", {
	/* ============================================================ */
	/* Constants                                                    */
	/* ============================================================ */
	/**
	...
	onInit : function() {
		...
		var oAnalysisObject = new sap.viz.ui5.controls.common.feeds.AnalysisObject(oCountry2VizFrame.analysisObjectProps);
