...
(function (utils, ChangePersistence, Control, Change, LrepConnector, Cache, Settings) {
	...
	QUnit.test("getChangesForView shall return the changes that are prefixed with the same view", function(assert) {
		...
		return this.oChangePersistence.getChangesForView({viewId: "view1--view2"}).then(function(changes) {
	...
	QUnit.test("getUnmergedChangesForView shall return the changes that are prefixed with the same view but not already mereged", function(assert) {
		...
		return this.oChangePersistence.getUnmergedChangesForView({viewId: "view1--view2"}).then(function(changes) {
