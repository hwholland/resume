sap.ui.controller("flSmartFormOpa.view.Main", {

/**
 * Called when a controller is instantiated and its View controls (if available) are already created. Can be used to modify the View before it is displayed, to
 * bind event handlers and do other one-time initialization.
 * 
 * @memberOf resources.sap.client.sFinApp.view.Main
 */
// onInit: function() {
//
// },
