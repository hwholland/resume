sap.ui.controller("sap.ui.comp.sample.personalization.example5.Example", {
	...
	onInit: function() {
		...
		this.oMockServer = new sap.ui.core.util.MockServer({
			rootUri: "demokit.personalization.example5/"
		});
		...
		this.oModel = new sap.ui.model.odata.ODataModel("demokit.personalization.example5", true);
