...
jQuery.sap.declare('sap.apf.testhelper.stub.ajaxStub');
...
(function() {
	 ...
	 */
	sap.apf.testhelper.stub.stubJQueryAjax = function() {
		...
		function ajaxStubbed(oConfig) {
			...
			if (oConfig.dataType === "json") {
				if (oConfig.url.search("apfMessageDefinition") !== -1) {
					tmp = sap.apf.testhelper.stub.givenApfMessageDefinition();
					fnOriginalSuccess(tmp, "success", undefined);
				} else if (oConfig.url.search("applicationMessageDefinition") !== -1) {
					tmp = sap.apf.testhelper.stub.givenApplicationMessageDefinition();
					fnOriginalSuccess(tmp, "success", undefined);
					...
					tmp = sap.apf.testhelper.stub.givenApplicationConfiguration();
					fnOriginalSuccess(tmp, "success", undefined);
				} else if ((oConfig.url.search("applicationConfigurationIntegration") !== -1)) {
					tmp = sap.apf.testhelper.stub.givenApplicationConfigurationIntegration();
					fnOriginalSuccess(tmp, "success", undefined);
				} else if ((oConfig.url.search("applicationConfigurationFacetFilter") !== -1)) {
					tmp = sap.apf.testhelper.stub.givenApplicationConfigurationFacetFilter();
					fnOriginalSuccess(tmp, "success", undefined);
				} else if ((oConfig.url.search("integrationSampleConfiguration") !== -1)) {
					tmp = sap.apf.testhelper.stub.givenIntegrationSampleConfiguration();
					fnOriginalSuccess(tmp, "success", undefined);
				} else if ((oConfig.url.search("sampleConfiguration") !== -1) && (oConfig.url.search("integrationSampleConfiguration") === -1)) {
					tmp = sap.apf.testhelper.stub.getSampleConfiguration();
					fnOriginalSuccess(tmp, "success", undefined);
				} else if ((oConfig.url.search("configurationFacetFilter") !== -1)) {
					tmp = sap.apf.testhelper.stub.getSampleConfiguration("addOneFacetFilters");
					fnOriginalSuccess(tmp, "success", undefined);
				} else if ((oConfig.url.search("savedPath") !== -1)) {
					tmp = sap.apf.testhelper.odata.getSavedPaths();
					fnOriginalSuccess(tmp, "success", undefined);
				}  else {
				...
				if ((oConfig.url.search("MessageDefinition") !== -1)) { // apfMessage or ApplicationMessage
					...
					fnOriginalAjax(oConfig); // <<<<<< HEAD on any other allowed resource OK
				}
	...
	sap.apf.testhelper.stub.givenApfMessageDefinition = null;
	sap.apf.testhelper.stub.givenApplicationMessageDefinition = null;
	sap.apf.testhelper.stub.givenApfMessagesProperties = null;
	sap.apf.testhelper.stub.givenApfUiProperties = null;
	sap.apf.testhelper.stub.givenApplicationConfiguration = null;
	sap.apf.testhelper.stub.givenApplicationConfigurationIntegration = null;
	// test.uilib.helper.config.applicationConfiguration*.json
	sap.apf.testhelper.stub.givenApplicationConfiguration = function() {
		return {
	...
	sap.apf.testhelper.stub.givenApplicationConfigurationFacetFilter = function() {
		return {
			"applicationConfiguration" : {
				"type" : "applicationConfiguration",
				"appName" : "appName",
	...
	sap.apf.testhelper.stub.givenApplicationConfigurationIntegration = function() {
		return {
			"applicationConfiguration" : {
				"type" : "applicationConfiguration",
				"appName" : "appName2",
	...
	sap.apf.testhelper.stub.givenApfMessageDefinition = function() {
		return {
	...
	sap.apf.testhelper.stub.givenApplicationMessageDefinition = function() {
		return {
			"messageConfiguration" : {
				"type" : "messageConfiguration",
	...
	sap.apf.testhelper.stub.givenJSONStringExperiment = function() {
		var str = "" 
			+ "# TRANSLATE\n" 
	...
	sap.apf.testhelper.stub.givenApfMessagesProperties = function(context) {
		...
		context.addText(5300, "You must log out of the application due to a critical error");
	...
	sap.apf.testhelper.config = sap.apf.testhelper.config || {};
	/**
	 *
	 ...
	 * @returns {*}
	 */
	sap.apf.testhelper.stub.getSampleConfiguration = function(sConfigChange) {
		var oConfig = {
			steps : [ {
				type : "step", // optional
				id : "stepTemplate1",
