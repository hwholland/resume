...
(function() {
	...
	QUnit.module("Toolbar unit tests", {
		beforeEach : function(assert) {
			...
			sap.apf.testhelper.modelerUIHelper.getModelerInstance(function(oModelerInstance) {
				...
				that.navigateToDifferntViewStub = function() {
					var doNothing;
				};
				...
				that.oTreeInstance.bindAggregation("nodes", "/aConfigDetails", oTreeNodeTemplate);
	...
	QUnit.test("Test handleAddMenuItemPress", function(assert) {
		...
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes().length, 3, "New configuration node was added on press of add configuration option in add menu");
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[2].getText(), "< " + this.oModelerInstance.modelerCore.getText("newConfiguration") + " >", "The new node has the text <New Configuration>");
		this.oConfigListInstance.oTreeInstance.setSelectionOnTree("/aConfigDetails/0");
		oEvtStub = {
			getParameters : function() {
				var obj = {};
		...
		this.toolbarController._handleAddMenuItemPress(oEvtStub);
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[0].getNodes().length, 3, "New facet filter node was added on press of add facet filter option in add menu ");
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[0].getNodes()[2].getText(), "< " + this.oModelerInstance.modelerCore.getText("newFacetFilter") + " >", "The new node has the text <New Facet Filter>");
		this.oConfigListInstance.oTreeInstance.setSelectionOnTree("/aConfigDetails/0");
		oEvtStub = {
			getParameters : function() {
				var obj = {};
		...
		this.toolbarController._handleAddMenuItemPress(oEvtStub);
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[1].getNodes().length, 3, "New category node was added on press of add category option in add menu ");
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[1].getNodes()[2].getText(), "< " + this.oModelerInstance.modelerCore.getText("newCategory") + " >", "The new node has the text <New Category>");
		...
		this.toolbarController._handleAddMenuItemPress(oEvtStub);
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[1].getNodes()[0].getNodes().length, 3, "New step node was added on press of add step option in add menu ");
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[1].getNodes()[0].getNodes()[2].getText(), "< " + this.oModelerInstance.modelerCore.getText("newStep") + " >", "The new node has the text <New Step>");
		...
		this.toolbarController._handleAddMenuItemPress(oEvtStub);
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[1].getNodes()[0].getNodes()[0].getNodes().length, 3, "New representation node was added on press of add representation option in add menu ");
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[1].getNodes()[0].getNodes()[0].getNodes()[2].getText(), "Column Chart", "The new node has the text Column Chart");
		oEvtStub = {
			getParameters : function() {
				var obj = {};
		...
		this.toolbarController._handleAddMenuItemPress(oEvtStub);
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[2].getNodes().length, 3, "New Navigation Target node was added on press of add navigation target option in add menu ");
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[2].getNodes()[2].getText(), "< " + this.oModelerInstance.modelerCore.getText("newNavigationTarget") + " >", "The new node has the text <New Navigation Target>");
	...
	QUnit.test("Test handle press copy button for representation", function(assert) {
		...
		this.toolbarController._handlePressCopyButton(oCopyButtonStub);
		assert.equal(this.oModel.getData().aConfigDetails[0].configData[1].categories[0].steps[0].representations[2].name, "Column Chart", "The selected representation node is copied");
		var existingRepresentation = this.oModelerInstance.unsavedStepWithoutFilterMapping.getRepresentations()[0];
		var copiedRepresentation = this.oModelerInstance.unsavedStepWithoutFilterMapping.getRepresentations()[2];
		...
		this.oModelerInstance.unsavedStepWithoutFilterMapping.removeRepresentation(this.oModel.getData().aConfigDetails[0].configData[1].categories[0].steps[0].representations[2].id);
	});
	...
	QUnit.test("Test _handlePressMoveUpButton for representation", function(assert) {
		...
		this.toolbarController._handlePressMoveUpButton();
		assert.equal(this.oModel.getData().aConfigDetails[0].configData[1].categories[0].steps[0].representations[0].name, "Line Chart", "representation is moved up in the tree");
	});
	...
	QUnit.test("Test handleAddExistingStepPress", function(assert) {
		...
		assert.equal(this.toolbarController.addExistingStepDialog.getItems().length, 2, "List of unassigned steps to category is created");
	});
