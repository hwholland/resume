...
(function() {
	...
	function ODataProxyStub() {
		...
		this.readEntity = function(entitySetName, callback, inputParameters, selectList, async) {
			this.assertData(entitySetName, callback, inputParameters, selectList, async);
		};
	}
	...
	QUnit.test("Register service and get all services", function(assert) {
		...
		assert.ok(editor.registerService("path/to/service/serviceName1"), "Service registered");
		assert.ok(editor.registerService("path/to/service/serviceName2"), "Service registered");
		assert.ok(editor.registerService("path/to/service/serviceName2"), "Service registered");
		...
		assert.ok(!editor.registerService("myInvalidService"), "Service not registerd");
	...
	QUnit.test("Register invalid service", function(assert) {
		var editor = new sap.apf.modeler.core.ConfigurationEditor("apf1972-tempId", this.inject);
		editor.registerService("myInvalidService");
		assert.equal(this.messageHandler.spyResults.putMessage, "messageObject", "Put message due to invalid service");
	});
	QUnit.test("Get all entity types of service", function(assert) {
		var editor = new sap.apf.modeler.core.ConfigurationEditor("apf1972-tempId", this.inject);
		assert.deepEqual(editor.getAllEntityTypesOfService("path/to/service/serviceName1"), [], "Not registered services returns empty array");
		editor.registerService("path/to/service/serviceName1");
		assert.deepEqual(editor.getAllEntityTypesOfService("path/to/service/serviceName1"), [ "entityType1", "entityType2" ], "All entity types of service retrieved");
		assert.deepEqual(editor.getAllEntityTypesOfService("myInvalidService"), [], "Invalid service returns empty array");
	});
	QUnit.test("Get all entity sets of service", function(assert) {
		var editor = new sap.apf.modeler.core.ConfigurationEditor("apf1972-tempId", this.inject);
		assert.deepEqual(editor.getAllEntitySetsOfService("path/to/service/serviceName1"), [], "Not registered services returns empty array");
		editor.registerService("path/to/service/serviceName1");
		assert.deepEqual(editor.getAllEntitySetsOfService("path/to/service/serviceName1"), [ "entitySet1", "entitySet2" ], "All entity sets of service retrieved");
		assert.deepEqual(editor.getAllEntitySetsOfService("myInvalidService"), [], "Invalid service returns empty array");
	});
	QUnit.test("Get all entity sets of service with given properties", function(assert) {
		var editor = new sap.apf.modeler.core.ConfigurationEditor("apf1972-tempId", this.inject);
		assert.deepEqual(editor.getAllEntitySetsOfServiceWithGivenProperties("path/to/service/serviceName1"), [], "Not registered services returns empty array");
		editor.registerService("path/to/service/serviceName1");
		assert.deepEqual(editor.getAllEntitySetsOfServiceWithGivenProperties("path/to/service/serviceName1"), [ "entitySet1", "entitySet2" ], "All entity sets of service retrieved for not given set of properties");
		assert.deepEqual(editor.getAllEntitySetsOfServiceWithGivenProperties("path/to/service/serviceName1", []), [ "entitySet1", "entitySet2" ], "All entity sets of service retrieved for empty set of properties");
		assert.deepEqual(editor.getAllEntitySetsOfServiceWithGivenProperties("myInvalidService"), [], "Invalid service returns empty array");
		assert.deepEqual(editor.getAllEntitySetsOfServiceWithGivenProperties("path/to/service/serviceName1", [ "property1", "property2" ]), [ "entitySet1" ], "Right set of entity sets returned");
		assert.deepEqual(editor.getAllEntitySetsOfServiceWithGivenProperties("path/to/service/serviceName1", [ "property2" ]), [ "entitySet1", "entitySet2" ], "Right set of entity sets returned");
		assert.deepEqual(editor.getAllEntitySetsOfServiceWithGivenProperties("path/to/service/serviceName1", [ "property3" ]), [ "entitySet2" ], "Right set of entity sets returned");
	});
	QUnit.test("Get all properties of entity set", function(assert) {
		var editor = new sap.apf.modeler.core.ConfigurationEditor("apf1972-tempId", this.inject);
		assert.deepEqual(editor.getAllEntitySetsOfService("path/to/service/serviceName1"), [], "Not registered services returns empty array");
		editor.registerService("path/to/service/serviceName1");
		assert.deepEqual(editor.getAllPropertiesOfEntitySet("path/to/service/serviceName1", "EntitySet"), [ "property1", "property2" ], "All properties of entity set retrieved");
		assert.deepEqual(editor.getAllPropertiesOfEntitySet("myInvalidService", "EntitySet"), [], "Invalid service returns empty array");
		assert.deepEqual(editor.getAllPropertiesOfEntitySet("path/to/service/serviceName1", "myInvalidEntitySet"), [], "Invalid entitySet returns empty array");
	});
	QUnit.test("Get all known properties of registered services", function(assert) {
		var editor = new sap.apf.modeler.core.ConfigurationEditor("apf1972-tempId", this.inject);
		editor.registerService("path/to/service/serviceName1");
		editor.registerService("path/to/service/serviceName2"); // No effect to test result because getAllProperties doubled. But indicator that duplicates are removed
		assert.deepEqual(editor.getAllKnownProperties(), [ "property1", "property2", "property3", "property4" ], "All known properties retrieved");
	});
	QUnit.test("Get all filterable properties and/or parameters of registered services", function(assert) {
		var editor = new sap.apf.modeler.core.ConfigurationEditor("apf1972-tempId", this.inject);
		editor.registerService("path/to/service/serviceName1");
		assert.deepEqual(editor.getFilterablePropertiesAndParameters(), [ "property1", "property3", "property4", "parameter5" ], "Correct properties retrieved");
	});
	...
	QUnit
			.test(
					"WHEN new ConfigurationEditor with argument of type object and new configuration ID THEN save calls create on ODataProxy",
					function(assert) {
	...
	QUnit
			.test(
					"WHEN new ConfigurationEditor with argument of type object and configuration ID exist THEN save calls update on ODataProxy",
					function(assert) {
	...
	QUnit
			.test(
					"WHEN new ConfigurationEditor with argument of type object and temp configuration ID THEN  save calls create on ODataProxy",
					function(assert) {
	...
	QUnit.test("Instantiation of configuration editor with server ID calls read on odataProxy", function(assert) {
		assert.expect(4);
		this.odataProxy.assertData = function(entitySetName, callback, inputParameters, selectList, async) {
			...
			assert.equal(async, true, "Asynchronous read");
		};
	...
	QUnit.test("Copy configuration with default filter option 'smartFilterBar'", function(assert) {
		...
		smartFilterBar.setEntityType("dummyEntityType");
		...
		assert.equal(copiedSmartFilterBar.getEntityType(), "dummyEntityType", "Copied SmartFilterBar has correct entity type");
	});
	QUnit.test("Copy configuration with filter option 'facetFilter'", function(assert) {
		...
		this.configurationEditor.registerService("path/to/service/serviceName1");
		this.configurationEditor.registerService("path/to/service/serviceName2");
		this.configurationEditor.createFacetFilter();
		this.configurationEditor.createFacetFilter();
	...
	QUnit.test("Simulate filter option change 'smartFilterBar' with entity tpye set", function(assert) {
		var smartFilterBar = this.configurationEditor.getSmartFilterBar();
		smartFilterBar.setEntityType('dummyEntityType');
		assert.equal(this.configurationEditor.isDataLostByFilterOptionChange(), true, 'Data loss when switching away from configured Smart Filter Bar');
	});
