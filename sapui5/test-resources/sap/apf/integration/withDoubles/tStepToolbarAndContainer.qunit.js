(function() {
	...
	var arrangement = sap.ui.test.Opa5.extend("arrangement", {
		globalSetup : function() {
			...
			oGlobalApi = new sap.apf.testhelper.doubles.UiApi("CompUi", "/apf-test/test-resources/sap/apf/testhelper/config/applicationConfigurationIntegration.json", inject);
	...
	opaTest("Toggle to Alternate Representation and Sort table test", (Given, When, Then) { //TODO
		// Arrangements
		Given.globalSetup();
