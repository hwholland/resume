...
sap.ui.controller("sap.apf.modeler.ui.controller.step", {
	...
	* */
	...
	onAfterRendering : function() {
		if (this.getView().byId("idstepTitle").getValue().length === 0) {
			this.getView().byId("idstepTitle").focus();
		}
	},
	/**
	* @private
	...
	* */
	_setDisplayText : function() {
		...
		this.byId("idGlobalLabel").setText(this.getText("globalNavigationTarget"));
