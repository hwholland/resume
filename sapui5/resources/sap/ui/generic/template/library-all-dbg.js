...
if ( !jQuery.sap.isDeclared('sap.ui.generic.template.AppComponent') ) {
/*
...
// ----------------------------------------------------------------------------------
jQuery.sap.declare('sap.ui.generic.template.AppComponent'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
...
jQuery.sap.require('sap.ui.generic.template.NavigationController'); // unlisted dependency retained
jQuery.sap.require('sap.m.NavContainer'); // unlisted dependency retained
sap.ui.define("sap/ui/generic/template/AppComponent",[
...
}; // end of sap/ui/generic/template/AppComponent.js
