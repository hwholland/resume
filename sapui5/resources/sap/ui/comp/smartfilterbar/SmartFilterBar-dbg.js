...
sap.ui.define([
	 ...
	 * @private
	 * @param {object} oField filter metadata
	 * @return {object} oField filter metadata
	 */
	...
	SmartFilterBar.prototype.triggerSearch = function(iDelay) {
		...
		this._iDelayedSearchId = jQuery.sap.delayedCall(iDelay || 0, this, "search");
	};
	 ...
	 * 
	 * @private
	 * @returns {boolean|undefined} true indicates that there are no validation problems
	 */
	...
	/**
	 * Clears the delayed Search trigger
	 * 
	 * @private
	 */
