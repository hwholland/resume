    ...
    sap.ui.jsview("sap.ushell.components.factsheet.views.ThingViewer", {
        ...
        createContent : function (oController) {
            ...
            function amendServiceUrlWithSapSystemIfRequired(oComponent, sServiceUrl) {
                ...
                if (sap.ui.model.odata && sap.ui.model.odata.ODataUtils && typeof sap.ui.model.odata.ODataUtils.setOrigin === "function") {
                    ...
                    if ( oComponent && oComponent.getComponentData() && oComponent.getComponentData().startupParameters &&
                         ...
                         sServiceUrl = sap.ui.model.odata.ODataUtils.setOrigin(sServiceUrl, { alias : sSystem });
                    }
                }
                return sServiceUrl;
            }
            ...
            oTI = sap.ushell.components.factsheet.factory.ThingInspector(sServiceUrl, sAnnotationUrl);
